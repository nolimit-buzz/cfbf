...
import type { EligibilityNextStepsSection } from '@/lib/strapi-eligibility-types';

type Props = Omit<EligibilityNextStepsSection, '__component'>;
...
export default function NextSteps(props: Props) {
  ...
  return (
    <>
      {/* Next Steps CTA Bar */}
      <section className="pt-12 pb-6 bg-brand-dark text-white relative z-10 border-t border-white/5">
        <motion.div
